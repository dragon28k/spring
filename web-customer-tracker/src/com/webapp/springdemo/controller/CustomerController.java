...
public class CustomerController {
	...
	public String listCustomer(Model theModel) {
		...
		theModel.addAttribute("customerObj",customer);
	...
	@GetMapping("/search")
	public String delete(@RequestParam("theSearchBox") String customerName, Model theModel) {
		
		List<Customer> customerList=customerService.searchCustomer(customerName);
		theModel.addAttribute("customerObj",customerList);
