	...
	public List<Customer> searchCustomer(String customerName) {
		...
		Query theQuery=null;
				if(customerName!=null && customerName!="") {
					theQuery=currentSession.createQuery("from Customer where lower(firstName) like :customerName or lower(lastName) like :customerName",Customer.class);
					theQuery.setParameter("customerName", "%"+customerName+"%");
				}else {
